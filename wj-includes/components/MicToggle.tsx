 ...
 *
 * Va junto al interruptor de sonido, que es cosa aparte: aquél decide si la
 * interfaz suena, éste abre una conversación. Colgar se hace desde el propio
 * asistente, que es donde se ve el estado de la llamada; un botón que a veces
 * llama y a veces cuelga, según un estado que no se ve desde aquí, se pulsa
 * mal.
 */
export default function MicToggle({ activa, onOpen }: MicToggleProps) {
  return (
    <button
      ...
      className={`fixed bottom-6 left-20 z-40 size-11 rounded-full bg-abyss/80 backdrop-blur-md border
