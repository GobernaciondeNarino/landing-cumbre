var $=Object.defineProperty;var X=(r,e,t)=>e in r?$(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var i=(r,e,t)=>X(r,typeof e!="symbol"?e+"":e,t);import{u as Y,r as c,j}from"./index-CqgIbnbL.js";import{S as k,C as J,V as x,W as K,P as Q,a as Z,M as ee,b as te,c as re,d as ie,L as H,e as S,B as ae,f as C,g as q,h as se,A as _,O as M}from"./three-BRHULVxx.js";const G=`
  float wjLuma(vec3 c) {
...
`;function ce(){if(typeof window>"u"||typeof document>"u")return!1;try{const r=document.createElement("canvas"),e=r.getContext("webgl2")??r.getContext("webgl")??r.getContext("experimental-webgl");if(!e)return!1;const t=e.getExtension("WEBGL_lose_context");return t==null||t.loseContext(),!0}catch{return!1}}function E(r=2){return typeof window>"u"?1:Math.min(window.devicePixelRatio||1,r)}const W=[["#009edb",.36],["#dce9ff",.28],["#ff6300",.22],["#feb100",.14]],P=34,de=26,fe=16;class he{constructor({canvas:e,variant:t,onContextLost:a}){i(this,"renderer");i(this,"fieldScene",new k);i(this,"figureScene",new k);i(this,"fieldCamera");i(this,"figureCamera",new J);i(this,"field");i(this,"fieldMaterial");i(this,"figure");i(this,"figureMaterial");i(this,"videoTexture",null);i(this,"video",null);i(this,"hasFrame",!1);i(this,"rvfcHandle",null);i(this,"pointerTarget",new x(0,0));i(this,"pointer",new x(0,0));i(this,"warmAlpha",.45);i(this,"auraIntensity",.32);i(this,"progressTarget",0);i(this,"progress",0);i(this,"energy",0);i(this,"opacity",1);i(this,"frameId",null);i(this,"running",!1);i(this,"disposed",!1);i(this,"clock",0);i(this,"lastTime",0);i(this,"onContextLost");i(this,"handleContextLost",e=>{var t;e.preventDefault(),this.stop(),(t=this.onContextLost)==null||t.call(this)});i(this,"tick",e=>{if(!this.running||this.disposed)return;this.frameId=requestAnimationFrame(this.tick);const t=Math.min((e-this.lastTime)/1e3,.05);this.lastTime=e,this.clock+=t;const a=this.pointerTarget.distanceTo(this.pointer),f=Math.abs(this.progressTarget-this.progress);this.energy=y(this.energy*.92+a*1.6+f*14,0,1),this.pointer.lerp(this.pointerTarget,1-Math.pow(.0015,t)),this.progress+=(this.progressTarget-this.progress)*(1-Math.pow(.002,t)),this.updateVideoTexture();const n=this.figureMaterial.uniforms;n.uPointer.value.copy(this.pointer),n.uTime.value=this.clock,n.uEnergy.value=this.energy,n.uOpacity.value=this.opacity,!this.hasFrame&&this.video&&this.video.readyState>=2&&this.video.videoWidth>0&&(this.hasFrame=!0),n.uHasFrame.value=this.hasFrame?1:0,this.video&&this.video.videoWidth>0&&n.uMediaSize.value.set(this.video.videoWidth,this.video.videoHeight);const o=this.fieldMaterial.uniforms;o.uPointer.value.copy(this.pointer),o.uTime.value=this.clock,o.uProgress.value=this.progress,o.uEnergy.value=this.energy,this.renderer.clear(),this.renderer.render(this.fieldScene,this.fieldCamera),this.renderer.render(this.figureScene,this.figureCamera)});this.onContextLost=a,this.renderer=new K({canvas:e,alpha:!0,antialias:!1,powerPreference:"high-performance",depth:!1,stencil:!1}),this.renderer.setPixelRatio(E()),this.renderer.setClearColor(0,0),this.renderer.autoClear=!1,e.addEventListener("webglcontextlost",this.handleContextLost),this.fieldCamera=new Q(55,1,.1,120),this.fieldCamera.position.set(0,0,6);const f=t==="hero"?950:1300,{geometry:n,material:o}=me(f,t);this.fieldMaterial=o,this.field=new Z(n,o),this.field.frustumCulled=!1,this.fieldScene.add(this.field),this.figureMaterial=pe(),this.figure=new ee(new te(2,2),this.figureMaterial),this.figure.frustumCulled=!1,this.figureScene.add(this.figure)}setVideo(e){if(this.disposed||e===this.video||(this.releaseVideo(),!e))return;this.video=e;const t=new re(e);t.colorSpace=ie,t.minFilter=H,t.magFilter=H,t.generateMipmaps=!1,this.videoTexture=t,this.figureMaterial.uniforms.uMap.value=t,typeof this.video.requestVideoFrameCallback=="function"&&this.scheduleFrameCallback()}setPalette(e,t="#009edb"){this.disposed||(this.warmAlpha=be(e),O(this.figureMaterial.uniforms.uWarm.value,e),O(this.figureMaterial.uniforms.uCool.value,t),this.applyAura())}setAura(e,t){this.disposed||(this.auraIntensity=e,this.figureMaterial.uniforms.uAuraSize.value=t,this.applyAura())}applyAura(){this.figureMaterial.uniforms.uAura.value=this.auraIntensity*(.6+this.warmAlpha)}setPointer(e,t){this.pointerTarget.set(y(e,-1,1),y(t,-1,1))}setProgress(e){this.progressTarget=y(e,0,1)}setOpacity(e){this.opacity=y(e,0,1)}resize(e,t){this.disposed||e===0||t===0||(this.renderer.setPixelRatio(E()),this.renderer.setSize(e,t,!1),this.fieldCamera.aspect=e/t,this.fieldCamera.updateProjectionMatrix(),this.figureMaterial.uniforms.uResolution.value.set(e,t),this.fieldMaterial.uniforms.uPixelRatio.value=E())}start(){this.disposed||this.running||(this.running=!0,this.lastTime=performance.now(),this.frameId=requestAnimationFrame(this.tick))}stop(){this.running=!1,this.frameId!==null&&(cancelAnimationFrame(this.frameId),this.frameId=null)}updateVideoTexture(){const e=this.videoTexture,t=this.video;!e||!t||typeof t.requestVideoFrameCallback!="function"&&t.readyState>=2&&(e.needsUpdate=!0)}scheduleFrameCallback(){const e=this.video;!e||typeof e.requestVideoFrameCallback!="function"||(this.rvfcHandle=e.requestVideoFrameCallback(()=>{this.disposed||(this.videoTexture&&(this.videoTexture.needsUpdate=!0),this.scheduleFrameCallback())}))}releaseVideo(){var e;this.video&&this.rvfcHandle!==null&&this.video.cancelVideoFrameCallback(this.rvfcHandle),this.rvfcHandle=null,this.hasFrame=!1,(e=this.videoTexture)==null||e.dispose(),this.videoTexture=null,this.figureMaterial.uniforms.uMap.value=null,this.video=null}dispose(){this.disposed||(this.stop(),this.disposed=!0,this.releaseVideo(),this.renderer.domElement.removeEventListener("webglcontextlost",this.handleContextLost),this.field.geometry.dispose(),this.fieldMaterial.dispose(),this.figure.geometry.dispose(),this.figureMaterial.dispose(),this.renderer.dispose())}}function me(r,e){const t=new Float32Array(r*3),a=new Float32Array(r*3),f=new Float32Array(r),n=new Float32Array(r),o=new S;for(let u=0;u<r;u+=1)t[u*3]=(Math.random()*2-1)*de,t[u*3+1]=(Math.random()*2-1)*fe,t[u*3+2]=Math.random()*P-(P-4),o.set(ve()),a[u*3]=o.r,a[u*3+1]=o.g,a[u*3+2]=o.b,f[u]=Math.random(),n[u]=.35+Math.pow(Math.random(),3.5)*1.1;const p=new ae;p.setAttribute("position",new C(t,3)),p.setAttribute("aColor",new C(a,3)),p.setAttribute("aSeed",new C(f,1)),p.setAttribute("aScale",new C(n,1));const v=new q({vertexShader:oe,fragmentShader:ne,uniforms:{uTime:{value:0},uPointer:{value:new x(0,0)},uProgress:{value:0},uEnergy:{value:0},uPixelRatio:{value:E()},uSize:{value:e==="hero"?7.5:5.5},uDepth:{value:P},uFieldAlpha:{value:e==="hero"?.62:.5}},transparent:!0,depthTest:!1,depthWrite:!1});return B(v),{geometry:p,material:v}}function pe(){const r=new q({vertexShader:le,fragmentShader:ue,uniforms:{uMap:{value:null},uResolution:{value:new x(1,1)},uMediaSize:{value:new x(1920,1080)},uPointer:{value:new x(0,0)},uTime:{value:0},uEnergy:{value:0},uOpacity:{value:1},uHasFrame:{value:0},uWarm:{value:new S("#ff6300")},uCool:{value:new S("#009edb")},uAura:{value:.32},uAuraSize:{value:.8}},transparent:!0,depthTest:!1,depthWrite:!1});return B(r),r}function B(r){r.blending=se,r.blendEquation=_,r.blendSrc=M,r.blendDst=M,r.blendEquationAlpha=_,r.blendSrcAlpha=M,r.blendDstAlpha=M}function ve(){const r=Math.random();let e=0;for(const[t,a]of W)if(e+=a,r<=e)return t;return W[0][0]}function O(r,e){try{r.setStyle(ge(e))}catch{r.set("#ff6300")}}function ge(r){const e=/^rgba\(\s*([^,]+),\s*([^,]+),\s*([^,)]+)[,)]/i.exec(r.trim());return e?`rgb(${e[1].trim()}, ${e[2].trim()}, ${e[3].trim()})`:r}function be(r){const e=/^rgba\(\s*[^,]+,\s*[^,]+,\s*[^,]+,\s*([^)]+)\)$/i.exec(r.trim());if(!e)return 1;const t=e[1].trim(),a=t.endsWith("%")?Number(t.slice(0,-1))/100:Number(t);return Number.isFinite(a)?y(a,0,1):1}function y(r,e,t){return Math.max(e,Math.min(t,r))}function Ce({video:r,variant:e,progress:t,opacity:a,glowColor:f,glowIntensity:n,glowSize:o,className:p,onActiveChange:v}){const u=Y(),[N]=c.useState(ce),[d,A]=c.useState(!1),T=c.useRef(null),R=c.useRef(null),g=c.useRef(null),F=N&&u!==!0;return c.useEffect(()=>{if(!F)return;const s=R.current,h=T.current;if(!s||!h)return;let m;try{m=new he({canvas:s,variant:e,onContextLost:()=>A(!1)})}catch{return}g.current=m;const L=h.getBoundingClientRect();m.resize(L.width,L.height),A(!0);const z=new ResizeObserver(b=>{var V;const l=(V=b[0])==null?void 0:V.contentRect;l&&m.resize(l.width,l.height)});z.observe(h);let D=!0;const w=()=>{D&&document.visibilityState==="visible"?m.start():m.stop()},I=new IntersectionObserver(b=>{var l;D=((l=b[0])==null?void 0:l.isIntersecting)??!0,w()},{threshold:0});I.observe(h),document.addEventListener("visibilitychange",w),w();const U=b=>{const l=h.getBoundingClientRect();l.width===0||l.height===0||m.setPointer((b.clientX-l.left)/l.width*2-1,-((b.clientY-l.top)/l.height*2-1))};return window.addEventListener("pointermove",U,{passive:!0}),()=>{window.removeEventListener("pointermove",U),document.removeEventListener("visibilitychange",w),I.disconnect(),z.disconnect(),m.dispose(),g.current=null,A(!1)}},[F,e]),c.useEffect(()=>{var s;d&&((s=g.current)==null||s.setVideo(r))},[d,r]),c.useEffect(()=>{if(!d)return;const s=g.current;s&&(s.setPalette(f),s.setAura(.16*n,o/110))},[d,f,n,o]),c.useEffect(()=>{if(!d)return;const s=g.current;if(s)return s.setProgress(t.get()),t.on("change",h=>s.setProgress(h))},[d,t]),c.useEffect(()=>{if(!d)return;const s=g.current;if(s){if(!a){s.setOpacity(1);return}return s.setOpacity(a.get()),a.on("change",h=>s.setOpacity(h))}},[d,a]),c.useEffect(()=>{v==null||v(d)},[d,v]),F?j.jsx("div",{ref:T,"aria-hidden":"true",className:p,children:j.jsx("canvas",{ref:R,className:"block size-full"})}):null}export{Ce as default};
